...
const components = {
    ...
    a: ({ className, ...props }: HTMLAttributes<HTMLAnchorElement>) => (
        <a className={cn('font-medium text-slate-900 underline underline-offset-4', className)} {...props} />
    ),
    ...
    tr: ({ className, ...props }: HTMLAttributes<HTMLTableRowElement>) => (
        <tr className={cn('m-0 border-t border-slate-300 p-0 even:bg-slate-100', className)} {...props} />
    ),
    ...
    pre: ({ className, ...props }: HTMLAttributes<HTMLPreElement>) => (
        <pre className={cn('mb-4 mt-6 overflow-x-auto rounded-lg bg-slate-900 py-4', className)} {...props} />
    ),
